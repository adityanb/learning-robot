...
//        RobotSpecification[] selectedRobots = engine.getLocalRepository("robots.BabyRobot,sample.Corners");
        RobotSpecification[] selectedRobots = engine.getLocalRepository("robots.MuscularRobot,sample.SittingDuck");
//        RobotSpecification[] selectedRobots = engine.getLocalRepository("robots.MuscularRobot,sample.Crazy");
