...
import com.learningsystems.robot.support.util.Normalization;
...
public class NeuralNetworkPredictor implements Predictor {
    ...
    public static class ExplodedInput implements Input {
        ...
        public ExplodedInput(QuantizedState state) {
            ...
            List<Normalization.Stat> stats = Normalization.Stat.load("/Users/aditya/Development/ML/LearningSystemsRLRobot/data/TrainingRuns/ExplodedLUT-Normalized-IN-6-HN-9-MTM-0.5-LR-4.0E-4-stats.txt");
        ...
        public FeedforwardNetwork network() {
            return FeedforwardNetwork.loadFromFile("/Users/aditya/Development/ML/LearningSystemsRLRobot/data/TrainingRuns/ExplodedLUT-Normalized-IN-6-HN-9-MTM-0.5-LR-4.0E-4-Weights.ser");
        }
    }

    public static class EncodedInput implements Input {
